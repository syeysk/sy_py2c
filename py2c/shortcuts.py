...
def trans(
    ...
    if write_to:
        translator = translator_class(save_to=write_to)
        translate(translator, source_code)
    else:
        file_stdout = StringIO()
        translator = translator_class(save_to=file_stdout)
        translate(translator, source_code)
...
def trans_c(
    ...
    return trans(source_code, TranslatorC, write_to)
...
def trans_cpp(
    ...
    return trans(source_code, TranslatorCpp, write_to)
